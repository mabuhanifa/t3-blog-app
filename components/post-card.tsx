  ...
  return (
    <article className="group rounded border border-stone-200 dark:border-stone-800 overflow-hidden hover:shadow-md transition">
      <div className="relative overflow-hidden">
        ...
        <span
          className={cn(
            "inline-flex items-center rounded-full bg-emerald-100 text-emerald-700 text-xs px-2 py-0.5 absolute top-2 left-2",
            labelClassName,
          )}
        >
          {label}
      ...
      <div className="p-4">
        ...
        <div className="text-stone-500 text-xs flex items-center gap-3">
          <img src={avatar || "/placeholder.svg"} alt="Author avatar" className="w-6 h-6 rounded-full object-cover" />
